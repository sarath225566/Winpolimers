                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    <div class="sidebar-widget  mb-30 ml-30">
                        ...
                        <div class="dashboard-menu">
                            <ul class="nav flex-column" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="dashboard-tab" data-bs-toggle="tab" href="#dashboard" role="tab" aria-controls="dashboard" aria-selected="false"><i class="fi-rs-settings-sliders mr-10"></i>Ayurvedhic</a>
                                </li>
                                <li class="nav-item">
