                        ...
                        <div class="loop-grid pr-30">
                            <div class="row">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    ...
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="#">Soups and Stews</a></h6>
                                        <h4 class="post-title mb-15">
                                            <a href="#">Summer Quinoa Salad Jars with Lemon Dill</a>
                                        </h4>
                                        <!-- <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                            <div>
                                                <span class="post-on mr-10">25 April 2022</span>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    ...
                                    <div class="entry-content-2">
                                        ...
                                        <h4 class="post-title mb-15">
                                            <a href="#">Caprese Chicken with Smashed Potatoes</a>
                                        </h4>
                                        <!-- <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                            <div>
                                                <span class="post-on mr-10">25 April 2022</span>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    ...
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="#">Dessert</a></h6>
                                        <h4 class="post-title mb-15">
                                            <a href="#">Harissa Chickpeas with Whipped Feta</a>
                                        </h4>
                                        <!-- <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                            <div>
                                                <span class="post-on mr-10">25 April 2022</span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            ...
                            <img src="assets/imgs/banner/banner-9.png" alt="newsletter" class="newsletter-img" />
                            <div class="col-md-6">
                                <div class="">
