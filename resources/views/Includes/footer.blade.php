                            ...
                            <div class="newsletter-content">
                                ...
                                <!-- <form class="form-subcriber d-flex">
                                    <input type="email" placeholder="Find Me On Whatsapp" />
                                      <a href="#"><img src="imgs/theme/icons/whatsapp.svg"></a>
                    ...
                    <div class="col-md-5">
                        <div class=" font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <ul class="contact-infor">
                                <li><img src="imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>: 5/520 Kanjany ,Thrissur KERALA</span></li>
                                <li><img src="imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us: </strong><span>9846912216 | 9497073174</span></li>
                                <li><img src="imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span>winpolymerskny2@gmail.com</span></li>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center zoom-in-zoom-out">
                    <img src="imgs/theme/loader.png" alt="" />
                </div>
            </div>
        </div>
    </div>
